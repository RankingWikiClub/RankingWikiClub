...
async function carregarBancoDaNuvem() {
  ...
  try {
    ...
    // Migração: se este dispositivo tem mais dados que a nuvem, envia para o Supabase.
    // Caso contrário, usa os dados centralizados da nuvem.
    if (nuvem && qtdNuvem >= qtdLocal && qtdNuvem > 0) {
