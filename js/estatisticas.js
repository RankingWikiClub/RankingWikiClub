            ...
            <tr>
              ...
              <td>
                <div class="estatistica-coluna-time sem-label">
                  ${linkParticipanteTabelaEstatistica(registro.campeaoId)}
                </div>
              </td>
              <td>
                <div class="estatistica-coluna-time sem-label">
                  ${linkParticipanteTabelaEstatistica(registro.viceId)}
                </div>
              </td>
            </tr>
          `).join("")}
        ...
        <tbody>
          ${edicoes.map(e => `
            <tr>
              ...
              <td>
                <div class="estatistica-coluna-time sem-label">
                  ${linkParticipanteTabelaEstatistica(e.campeaoId)}
                </div>
              </td>
              <td>
                <div class="estatistica-coluna-time sem-label">
                  ${linkParticipanteTabelaEstatistica(e.viceId)}
                </div>
              </td>
            </tr>
          `).join("")}
